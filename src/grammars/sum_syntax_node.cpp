...
SumSyntaxNode::SumSyntaxNode( const FSyntaxNodeSP& f0, const FSyntaxNodeSP& f1 ): ISyntaxNode{ Token_Type::SUM }
{
    Add( f0 );
    Add( f1 );
}
...
void SumSyntaxNode::accept( const ISyntaxNodeVisitorSP& visitor ) { visitor->visit( shared_from_this() ); }
