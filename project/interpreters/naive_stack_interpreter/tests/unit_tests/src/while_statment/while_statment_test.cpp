...
TEST( NAIVE_STACK_INTERPRETER_WHILE_STATMENT, DISABLED_FACTORIAL )
{
    // ARRANGE
...
TEST( NAIVE_STACK_INTERPRETER_WHILE_STATMENT, DISABLED_NESTED_LOOP )
{
    // ARRANGE
    const auto& input = R"""({ 
        var total = 0; 
...
TEST( NAIVE_STACK_INTERPRETER_WHILE_STATMENT, DISABLED_BREAK_CONDITION_FALSE )
{
    // ARRANGE
...
TEST( NAIVE_STACK_INTERPRETER_WHILE_STATMENT, DISABLED_WITH_ARRAY_MODIFICATION )
{
    // ARRANGE
    const auto& input = R"""({ 
        var arr = [1, 2, 3]; 
