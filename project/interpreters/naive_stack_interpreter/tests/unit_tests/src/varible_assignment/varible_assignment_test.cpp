...
TEST( NAIVE_STACK_INTERPRETER_VARIBLE_ASSIGNMENT, DISABLED_LOCAL_READ_WRITE_STRING )
{
   // ARRANGE
...
TEST( NAIVE_STACK_INTERPRETER_VARIBLE_ASSIGNMENT, DISABLED_GLOBAL_READ_WRITE_STRING )
{
   // ARRANGE
