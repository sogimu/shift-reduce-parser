...
TEST( NAIVE_STACK_INTERPRETER_COMPLEX_SCENARIOS, DISABLED_WHILE_WITH_IF_AND_FUNCTIONS )
{
    // ARRANGE
    const auto& input = R"""({
        function isEven(n) {
...
TEST( NAIVE_STACK_INTERPRETER_COMPLEX_SCENARIOS, DISABLED_ARRAY_PROCESSING_WITH_FUNCTIONS )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( NAIVE_STACK_INTERPRETER_COMPLEX_SCENARIOS, DISABLED_OBJECT_MANIPULATION_WITH_LOOPS )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( NAIVE_STACK_INTERPRETER_COMPLEX_SCENARIOS, DISABLED_NESTED_FUNCTION_WITH_CLOSURE )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( NAIVE_STACK_INTERPRETER_COMPLEX_SCENARIOS, DISABLED_RECURSIVE_TREE_TRAVERSAL )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( NAIVE_STACK_INTERPRETER_COMPLEX_SCENARIOS, DISABLED_MATRIX_OPERATIONS )
{
    // ARRANGE
    const auto& input = R"""({
...
TEST( NAIVE_STACK_INTERPRETER_COMPLEX_SCENARIOS, DISABLED_SCOPE_AND_VARIABLE_SHADOWING )
{
    // ARRANGE
    const auto& input = R"""({
        var global_x = 100;
...
TEST( NAIVE_STACK_INTERPRETER_COMPLEX_SCENARIOS, DISABLED_CALCULATOR_WITH_OPERATIONS )
{
    // ARRANGE
    const auto& input = R"""({
