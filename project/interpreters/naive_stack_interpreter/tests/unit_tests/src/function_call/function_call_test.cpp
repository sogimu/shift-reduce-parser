...
TEST( NAIVE_STACK_INTERPRETER_FUNCTION_CALL, DISABLED_FUNCTION_RETURNING_FUNCTION )
{
   // ARRANGE
   const auto& input = R"""({
...
TEST( NAIVE_STACK_INTERPRETER_FUNCTION_CALL, DISABLED_FUNCTION_WITH_ARRAY_PARAMETER )
{
   // ARRANGE
   const auto& input = R"""({
