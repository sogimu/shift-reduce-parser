...
TEST( NAIVE_STACK_INTERPRETER_CFG_POSITIVE_ARITHMETIC, DISABLED_MINUS_INT_SEMICOLON )
{
   // ARRANGE
   const auto& input = R"""(-1;)""";
   const auto& lexical_tokens = LexicalTokens( input );
...
TEST( NAIVE_STACK_INTERPRETER_CFG_POSITIVE_ARITHMETIC, DISABLED_UN_EXPR_LAST )
{
   // ARRANGE
...
TEST( NAIVE_STACK_INTERPRETER_CFG_POSITIVE_ARITHMETIC, DISABLED_UN_EXPR_NOT_LAST )
{
   // ARRANGE
...
// }
//
TEST( NAIVE_STACK_INTERPRETER_CFG_POSITIVE_ARITHMETIC, DISABLED_ONE_PLUS )
{
   // ARRANGE
   const auto& input = R"""(1+2;)""";
   const auto& lexical_tokens = LexicalTokens( input );
