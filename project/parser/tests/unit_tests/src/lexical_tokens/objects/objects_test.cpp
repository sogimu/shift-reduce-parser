...
TEST( LEXICAL_TOKENS_OBJECTS, DEFINITION )
{
   ...
   LexicalTokens::LexicalToken t5{ .text="}", .type=Token_Type::CLOSE_CURLY_BRACKET, .line=1, .col=14, .length=1 };
   EXPECT_EQ( lexical_tokens[5], t5 );
   LexicalTokens::LexicalToken t6{ .text="", .type=Token_Type::EOL, .line=0, .col=0, .length=0 };
