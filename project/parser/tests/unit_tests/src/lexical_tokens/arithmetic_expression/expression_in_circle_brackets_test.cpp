...
TEST( EXPRESSIONS_IN_CIRCLE_BRACKETS, DIVIDE_IN_CIRCLIE_BRACKETS )
{
   ...
   LexicalTokens::LexicalToken t2{ .text="1", .type=Token_Type::INT, .line=0, .col=1, .length=1 };
   ...
   LexicalTokens::LexicalToken t4{ .text="2", .type=Token_Type::INT, .line=0, .col=3, .length=1 };
...
TEST( EXPRESSIONS_IN_CIRCLE_BRACKETS, ADVANCE_EXPRESSION )
{
   ...
   EXPECT_EQ( lexical_tokens[6], t6 );
   LexicalTokens::LexicalToken t7{ .text="3", .type=Token_Type::INT, .line=0, .col=6, .length=1 };
   EXPECT_EQ( lexical_tokens[7], t7 );
