...
TEST( EXPRESSIONS_IN_CIRCLE_BRACKETS, DIVIDE_IN_CIRCLIE_BRACKETS )
{
   ...
   LexicalTokens::LexicalToken t1{ .text="(", .type=Token_Type::OPEN_CIRCLE_BRACKET, .line=0, .col=0, .length=1 };
   EXPECT_EQ( lexical_tokens[1], t1 );
   LexicalTokens::LexicalToken t2{ .text="1", .type=Token_Type::NUMBER, .line=0, .col=1, .length=1 };
   EXPECT_EQ( lexical_tokens[2], t2 );
   LexicalTokens::LexicalToken t3{ .text="/", .type=Token_Type::SLASH, .line=0, .col=2, .length=1 };
   EXPECT_EQ( lexical_tokens[3], t3 );
   LexicalTokens::LexicalToken t4{ .text="2", .type=Token_Type::NUMBER, .line=0, .col=3, .length=1 };
   EXPECT_EQ( lexical_tokens[4], t4 );
   LexicalTokens::LexicalToken t5{ .text=")", .type=Token_Type::CLOSE_CIRCLE_BRACKET, .line=0, .col=4, .length=1 };
...
TEST( EXPRESSIONS_IN_CIRCLE_BRACKETS, ADVANCE_EXPRESSION )
{
   ...
   LexicalTokens::LexicalToken t5{ .text=")", .type=Token_Type::CLOSE_CIRCLE_BRACKET, .line=0, .col=4, .length=1 };
   EXPECT_EQ( lexical_tokens[5], t5 );
   LexicalTokens::LexicalToken t6{ .text="*", .type=Token_Type::ASTERISK, .line=0, .col=5, .length=1 };
   EXPECT_EQ( lexical_tokens[6], t6 );
   LexicalTokens::LexicalToken t7{ .text="3", .type=Token_Type::NUMBER, .line=0, .col=6, .length=1 };
   EXPECT_EQ( lexical_tokens[7], t7 );
