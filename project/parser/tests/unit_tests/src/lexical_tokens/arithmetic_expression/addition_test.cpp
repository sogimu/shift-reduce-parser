...
TEST( LEXICAL_TOKENS_ADDITION, DOUBLE_PLUS_DOUBLE )
{
   // ARRANGE
   const auto& input = R"""(1.3+2.4;)""";
   ...
   LexicalTokens::LexicalToken t1{ .text="1.3", .type=Token_Type::DOUBLE, .line=0, .col=0, .length=3 };
   EXPECT_EQ( lexical_tokens[1], t1 );
   LexicalTokens::LexicalToken t2{ .text="+", .type=Token_Type::PLUS, .line=0, .col=3, .length=1 };
   EXPECT_EQ( lexical_tokens[2], t2 );
   LexicalTokens::LexicalToken t3{ .text="2.4", .type=Token_Type::DOUBLE, .line=0, .col=4, .length=3 };
   EXPECT_EQ( lexical_tokens[3], t3 );
   LexicalTokens::LexicalToken t4{ .text=";", .type=Token_Type::SEMICOLON, .line=0, .col=7, .length=1 };
...
TEST( LEXICAL_TOKENS_ADDITION, DOUBLE_PLUS_INT )
{
   // ARRANGE
   const auto& input = R"""(1.5+2;)""";
   ...
   LexicalTokens::LexicalToken t0{ .text="", .type=Token_Type::BOL, .line=0, .col=0, .length=0 };
   EXPECT_EQ( lexical_tokens[0], t0 );
   LexicalTokens::LexicalToken t1{ .text="1.5", .type=Token_Type::DOUBLE, .line=0, .col=0, .length=3 };
   EXPECT_EQ( lexical_tokens[1], t1 );
   LexicalTokens::LexicalToken t2{ .text="+", .type=Token_Type::PLUS, .line=0, .col=3, .length=1 };
   EXPECT_EQ( lexical_tokens[2], t2 );
...
TEST( LEXICAL_TOKENS_ADDITION, INT_PLUS_DOUBLE )
{
   // ARRANGE
   ...
   EXPECT_EQ( lexical_tokens[2], t2 );
   LexicalTokens::LexicalToken t3{ .text="2.3", .type=Token_Type::DOUBLE, .line=0, .col=2, .length=3 };
   EXPECT_EQ( lexical_tokens[3], t3 );
   LexicalTokens::LexicalToken t4{ .text=";", .type=Token_Type::SEMICOLON, .line=0, .col=5, .length=1 };
   EXPECT_EQ( lexical_tokens[4], t4 );
   LexicalTokens::LexicalToken t5{ .text="", .type=Token_Type::EOL, .line=0, .col=0, .length=0 };
...
TEST( LEXICAL_TOKENS_ADDITION, INT_PLUS_INT )
{
   // ARRANGE
...
TEST( LEXICAL_TOKENS_ADDITION, MANY_PLUSs )
{
   ...
   LexicalTokens::LexicalToken t7{ .text="4", .type=Token_Type::INT, .line=0, .col=6, .length=1 };
