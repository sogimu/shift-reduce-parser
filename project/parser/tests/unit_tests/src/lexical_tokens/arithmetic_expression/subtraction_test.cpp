...
TEST( SUBTRACTION, ONE_MINUS )
{
   ...
   LexicalTokens::LexicalToken t2{ .text="-", .type=Token_Type::MINUS, .line=0, .col=1, .length=1 };
...
TEST( SUBTRACTION, MANY_MINUSs )
{
   ...
   LexicalTokens::LexicalToken t3{ .text="2", .type=Token_Type::INT, .line=0, .col=2, .length=1 };
   EXPECT_EQ( lexical_tokens[3], t3 );
   LexicalTokens::LexicalToken t4{ .text="-", .type=Token_Type::MINUS, .line=0, .col=3, .length=1 };
   EXPECT_EQ( lexical_tokens[4], t4 );
   LexicalTokens::LexicalToken t5{ .text="3", .type=Token_Type::INT, .line=0, .col=4, .length=1 };
   EXPECT_EQ( lexical_tokens[5], t5 );
   LexicalTokens::LexicalToken t6{ .text="-", .type=Token_Type::MINUS, .line=0, .col=5, .length=1 };
