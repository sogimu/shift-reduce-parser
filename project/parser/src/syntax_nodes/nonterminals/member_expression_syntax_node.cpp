...
MemberExpressionSyntaxNode::MemberExpressionSyntaxNode( const NameSyntaxNodeSP& target, const ISyntaxNodeSP& key_or_index_node, const std::vector< LexicalTokens::LexicalToken >& lexical_tokens )
   : ISyntaxNode{ Token_Type::MEMBER_EXPRESSION }
{
