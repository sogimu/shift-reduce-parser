...
public:
   Assigment()
   {
      //        mProductionByFeature.emplace_back(Features{one(Token_Type::NAME), one(Token_Type::EQUAL),
      //        one(Token_Type::F), one(Token_Type::SEMICOLON)}, [](const Stack& stack) -> Production
      //        {
      //            auto it = stack.begin();
      ...
      //        mProductionByFeature.emplace_back(Features{one(Token_Type::NAME), one(Token_Type::EQUAL),
      //        one(Token_Type::E), one(Token_Type::SEMICOLON)}, [](const Stack& stack) -> Production
      //        {
      //            auto it = stack.begin();
      //            std::advance(it, stack.size() - 4);
      //            const auto& name = *it;
      ...
      //        mProductionByFeature.emplace_back(Features{one(Token_Type::NAME), one(Token_Type::EQUAL),
      //        one(Token_Type::T), one(Token_Type::SEMICOLON)}, [](const Stack& stack) -> Production
      //        {
      //            auto it = stack.begin();
      //            std::advance(it, stack.size() - 4);
      //            const auto& name = *it;
      ...
      //        mProductionByFeature.emplace_back(Features{one(Token_Type::NAME), one(Token_Type::EQUAL),
      //        one(Token_Type::P), one(Token_Type::SEMICOLON)}, [](const Stack& stack) -> Production
      //        {
      //            auto it = stack.begin();
      //            std::advance(it, stack.size() - 4);
      //            const auto& name = *it;
      ...
      //        mProductionByFeature.emplace_back(Features{one(Token_Type::BOL), one(Token_Type::ASSIGMENT),
