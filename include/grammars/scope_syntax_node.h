...

{
    ...
    ScopeSyntaxNode( const ISyntaxNodeSP& expression ): ISyntaxNode{ Token_Type::SCOPE_EXPRESSION }
    {
        Add( expression );
    }

    ScopeSyntaxNode( const std::vector<ISyntaxNodeSP>& expressions ): ISyntaxNode{ Token_Type::SCOPE_EXPRESSION }
    {
