...
public:
   E()
   {
      ...
      //        mProductionByFeature.emplace_back(Features{one(Token_Type::DIFF)}, [this](const Stack& stack) ->
      //        Production
      //        {
      //            auto it = stack.begin();
      ...
      //        mProductionByFeature.emplace_back(Features{one(Token_Type::BOL), one(Token_Type::E),
