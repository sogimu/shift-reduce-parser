      ...
      mProductions.emplace_back(
         [ this ]( const Stack& stack ) -> std::optional< Plan >
         {
            ...
            handlers.if_expression_syntax_node =
               [ &if_expression_syntax_node, &state ]( const IfExpressionSyntaxNodeSP& node )
            {
      ...
      mProductions.emplace_back(
         [ this ]( const Stack& stack ) -> std::optional< Plan >
         {
            ...
            handlers.print_expression_syntax_node =
               [ &print_expression_syntax_node, &state ]( const PrintExpressionSyntaxNodeSP& node )
            {
               if( state == State::START )
               {
      ...
      mProductions.emplace_back(
         [ this ]( const Stack& stack ) -> std::optional< Plan >
         {
            ...
            handlers.computational_expression_syntax_node =
               [ &computational_expression_syntax_node, &state ]( const ComputationalExpressionSyntaxNodeSP& node )
            {
               if( state == State::START )
               {
            ...
            const auto& expression_node =
               std::make_shared< ExpressionSyntaxNode >( computational_expression_syntax_node );
      ...
      mProductions.emplace_back(
         [ this ]( const Stack& stack ) -> std::optional< Plan >
         {
            ...
            handlers.conditional_expression_syntax_node =
               [ &conditional_expression_syntax_node, &state ]( const ConditionalExpressionSyntaxNodeSP& node )
            {
               if( state == State::START )
               {
            ...
            const auto& expression_syntax_node =
               std::make_shared< ExpressionSyntaxNode >( conditional_expression_syntax_node );
            plan.to_add.nodes.push_back( expression_syntax_node );
            return plan;
         } );
      ...
      mProductions.emplace_back(
         [ this ]( const Stack& stack ) -> std::optional< Plan >
         {
            ...
            handlers.varible_assigment_syntax_node =
               [ &varible_assigment_syntax_node, &state ]( const VaribleAssigmentSyntaxNodeSP& node )
            {
               if( state == State::START )
               {
            ...
            const auto& expression_syntax_node =
               std::make_shared< ExpressionSyntaxNode >( varible_assigment_syntax_node );
            plan.to_add.nodes.push_back( expression_syntax_node );
            return plan;
         } );
   }
